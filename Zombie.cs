namespace Game
{
    public class Zombie : Monster
    {
        ...
        private int _virus;   // Medusa can use snake to fight 10 times.
        ...
        public Zombie(string name = "Zombie", int strength = 105, int agility = 70, int rewardXP = 20, int rewardAg = 12, int rewardSt = 15, int virus = 15)
        {
        ...
        private void Attack2(Player p)
        {
            ...
            int damagePts = _virus * Convert.ToInt32(_agility / 100);
            _virus--;
