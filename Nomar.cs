namespace Game
{
    public class Nomar : Monster
    {

        private int _spellEffect;   // Medusa can use snake to fight 10 times.
        ...
        public Nomar(string name = "Nomar", int strength = 90, int agility = 75, int rewardXP = 15, int rewardAg = 12, int rewardSt = 15, int spellEffect = 7)
        {
        ...
        private void Attack2(Player p)
        {
            ...
            int damagePts = _spellEffect * Convert.ToInt32(_agility / 100);
            _spellEffect--;
