namespace Game
{
    public class SwordSnatcher : Monster
    {

        private int _beserk;   // Medusa can use snake to fight 10 times.
        private float _swordMultiply = 1.9f;
        ...
        public SwordSnatcher(string name = "SwordSnatcher", int strength = 110, int agility = 95, int rewardXP = 30, int rewardAg = 12, int rewardSt = 15, int beserk = 10)
        {
        ...
        private void Attack2(Player p)
        {
            ...
            int damagePts = _beserk * Convert.ToInt32(_agility / 100);
            _beserk--;
