namespace Game
{
    public class Abaddon : Monster
    {
        ...
        public Abaddon(string name = "Abaddon", int strength = 110, int agility = 95, int rewardXP = 30, int rewardAg = 12, int rewardSt = 15, int beserk = 10)
        {
